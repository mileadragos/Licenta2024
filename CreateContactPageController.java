...
public class CreateContactPageController implements Initializable {
    ...
    private void createContact() {
        ...
        createContactInDatabase(createdContact);
    }


    private void createContactInDatabase(Contacts updatedContact) {
        String insertQuery = "INSERT INTO contact( nume_contact, prenume_contact, functie, email, telefon, companie_id, activ, responsabil, data_creare, creat_de) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPassword);
            ...
            if (rowsUpdated > 0) {
                statusUpdate.setText("Contactul a fost creat cu succes!");
